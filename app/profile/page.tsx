    ...
    <div className="min-h-screen bg-grid-soft bg-[radial-gradient(circle_at_top,_#edf4ff_0%,_#f8fbff_35%,_#ffffff_72%)]">
      <main className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <ProfileOverview
          ...
          roleTone="border border-indigo-200 bg-indigo-50 text-indigo-700"
          avatarTone="border-indigo-200 bg-indigo-50 text-indigo-700"
          glowTone="bg-indigo-200/70"
          user={user}
          summaryTitle="Akun siap dipakai"
          summaryText="Gunakan halaman ini untuk melihat status akun pribadi, memantau belanja, lalu lanjut ke keranjang atau checkout dengan jalur yang lebih singkat." 
          meta={[
