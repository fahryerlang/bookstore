...
export default function UserPanelShell({ user, children }: UserPanelShellProps) {
  return (
    <div className="flex h-screen gap-4 overflow-hidden bg-grid-soft bg-[radial-gradient(circle_at_top,_#edf5ff_0%,_#f8fbff_32%,_#ffffff_68%)] p-3 sm:p-4">
      ...
      <div className="relative flex min-w-0 flex-1 flex-col overflow-x-hidden overflow-y-auto rounded-[32px] border border-white/70 bg-white/84 shadow-[0_38px_95px_-65px_rgba(15,23,42,0.68)]">
        ...
        <header className="sticky top-0 z-30 flex items-center justify-between gap-4 border-b border-white/70 bg-white/92 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <nav className="relative z-20 border-b border-white/70 bg-white/92 px-4 py-3 lg:hidden sm:px-6">
